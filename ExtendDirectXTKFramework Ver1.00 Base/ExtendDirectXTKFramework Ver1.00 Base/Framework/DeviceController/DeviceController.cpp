...
//===============================================================================================
//	@class	Framework::DeviceController "DeviceController.h"
//	@fn		DeviceController::DeviceController( )
//	@brief	{	コンストラクタ
//				各種デバイス制御クラスの構築処理を行う	}
//	@return	{	なし	}
//-----------------------------------------------------------------------------------------------
...
//===============================================================================================
//	@class	Framework::DeviceController "DeviceController.h"
//	@fn		DeviceController::InitializeDevice( )
//	@Brief	{	イニシャライザ
//					}
...
//===============================================================================================
//	@class	Framework::DeviceController "DeviceController.h"
//	@fn		DeviceController::CreateBackBuffer( )
//	@Brief	{	バックバッファを作成する
//					}
//	@return	{	成功を表すS_OK定数を返す
//				または、エラー発生時にエラーを表すE_FAIL定数を返す	}
...
//===============================================================================================
//	@class	Framework::DeviceController "DeviceController.h"
//	@fn		DeviceController::ResizeBackBuffer( )
