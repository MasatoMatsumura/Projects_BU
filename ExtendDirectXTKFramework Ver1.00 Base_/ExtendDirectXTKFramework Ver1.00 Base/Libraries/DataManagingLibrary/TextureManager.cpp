...
textureID_t TextureManager::Load_Texture( textureFileName_t fileName )
{
	...
	{
		this->m_TextureMap[ fileName ] = std::make_shared<ID3D11ShaderResourceView*>( );
		...
		if( this->m_TextureMap[ fileName ] == nullptr )
		{
...
ID3D11ShaderResourceView* TextureManager::Get_Texture( textureID_t getTextureID )
{
	...
	return reinterpret_cast<ID3D11ShaderResourceView*>( this->m_TextureMap[ this->m_TextureIDLink[ getTextureID -1 ] ].get( ) );
}